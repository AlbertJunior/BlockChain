...
contract Auction {
    ...
    function bid(uint) public virtual returns (bool) {}
...
contract MyAuction is Auction {
    ...
    function bid(uint value) public an_ongoing_auction override returns (bool) {
        require(tokenContract.allowance(msg.sender, address(this)) >= value);
